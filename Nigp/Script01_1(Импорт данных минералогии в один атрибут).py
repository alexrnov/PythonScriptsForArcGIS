...
def write_to_layer(lay, C_System, array_map):
	...
	gp.AddField(OutputFC,"название_участка","STRING","","",100)#атрибут - название участка
	...
	gp.AddField(OutputFC,"находки_МСА","STRING","","",1000)#атрибут - информация по МСА
	gp.AddField(OutputFC,"отметка_кровли_пластов","STRING","","",1000)#атрибут для глубин кровли пластов
        gp.AddField(OutputFC,"отметка_подошвы_пластов","STRING","","",1000)#атрибут для глубин подошвы пластов
...
if __name__== '__main__':#если модуль запущен, а не импортирован
        ...
        if(len(arr_view_strat_lit)==0):#если нет скважин со стратолитологическим описанием
                ...
                if(Full_report == "true"):#выводить полный отчет
                        ...
                        ARCPY.AddMessage("-----------------------------------------------------------------------------------")         
        #получить массив с названием атрибутов excel-листа(шапки) и массив считанных строк excel-листа 
